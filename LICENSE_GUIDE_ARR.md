...
Here are examples of what is still practically allowed (things that's not be the target of copyright, as well as gray areas that I personally consider acceptable):
...
- Copy and paste small parts of the code to use it template-ish
  - Examples:
    - Copy a custom Item class to implement your own, to ensure it contains necessary overridden methods such as `OnHeldInteractStart` and follows common ways to call vanilla methods
    - Copy frequently used idioms/snippets of vanilla methods
  - Either way, make sure the final product different enough from the original
